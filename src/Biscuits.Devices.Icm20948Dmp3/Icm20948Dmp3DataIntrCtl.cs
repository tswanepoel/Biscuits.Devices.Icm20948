...
{
    public struct Icm20948Dmp3DataIntrCtl
    {
        ...
        private Icm20948Dmp3DataIntrCtl(ushort value)
        {
            _value = value;
        }

        public static explicit operator Icm20948Dmp3DataIntrCtl(ushort value)
        {
            return new Icm20948Dmp3DataIntrCtl(value);
        }

        public static implicit operator ushort(Icm20948Dmp3DataIntrCtl dataIntrCtl)
        {
            return dataIntrCtl._value;
        }
    }
}
